...
Our complete measurement dataset — all text samples and their token counts — is available in our [data folder on GitHub](https://github.com/marisaproject0313-bot/marisa-project/tree/main/data), including conversion constants, the full calorie table, and context degradation measurements.
